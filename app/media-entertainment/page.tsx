...
const content = `<!-- Page Hero Start -->
        <section class="story-hero" style="background: linear-gradient(rgba(10,15,30,0.7), rgba(10,15,30,0.8)), url('images/Industries/Sunware_Industries_Media-and-Entertainment_Banner.png'); background-size: cover; background-position: center top; min-height: 400px; padding: 80px 0 100px 0;">
